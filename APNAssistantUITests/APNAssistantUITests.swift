...
class APNAssistantUITests: XCTestCase {
    ...
    private func createFullAPN(app: XCUIApplication) {
        ...
        let dataApnNameCellsQuery = tablesQuery.cells.containing(.staticText, identifier:"Data apn name")
        ...
        let dataApnUserNameCellsQuery = tablesQuery.cells.containing(.staticText, identifier:"Data apn user name")
        ...
        let dataApnPasswordCellsQuery = tablesQuery.cells.containing(.staticText, identifier:"Data apn password")
        ...
        tablesQuery.cells.containing(.staticText, identifier:"Data apn protocol").textFields["nothing"].tap()
