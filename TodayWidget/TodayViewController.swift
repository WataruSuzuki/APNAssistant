...
class TodayViewController: UIViewController, NCWidgetProviding {
    ...
    override func viewDidLoad() {
        ...
        buttonOpenApp.setTitle(NSLocalizedString("openApp", comment: ""), forState: .Normal)
    ...
    @IBAction func tapOpenAppButton(sender: UIButton) {
        self.extensionContext?.openURL(NSURL(string: "applerejectapnassistant://")!, completionHandler: nil)
    }
}
